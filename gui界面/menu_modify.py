...
class Select_frame(tk.Frame):
    ...
    def create_page(self):
        ...
        self.tree_view.column('chinese', width=200, anchor='center')
        self.tree_view.column('math', width=200, anchor='center')
        self.tree_view.column('english', width=200, anchor='center')
